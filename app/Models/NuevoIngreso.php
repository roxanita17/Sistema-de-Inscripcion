...
public static function obtenerDatosInscripcion($buscar = null)
{
    $query = DB::table('nuevo_ingresos')
        ->select(
            ...
            'estudiante_persona.tipo_documento_id as estudiante_tipo_cedula',
            'estudiante_persona.numero_documento as estudiante_cedula',
            ...
            'representante_persona.tipo_documento_id as representante_tipo_cedula',
            'representante_persona.numero_documento as representante_cedula',
