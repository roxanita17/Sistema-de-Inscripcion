...
<div class="container mt-4">
    ...
    @include('admin.materia.modales.createModal')
            ...
            <tbody id="tbodyAnioEscolar">
                ...
                @if ($datos->status == true)
                    <tr>
                        ...
                        @endif --}}
                        <td>{{ $datos->codigo_materia }}</td>
                        <td>{{ $datos->nombre_materia }}</td>
                        ...
                        <td>
                            ...
                            @include('admin.materia.modales.editModal')
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="{{ url('admin/materia/' . $datos->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
