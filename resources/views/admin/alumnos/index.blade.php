                ...
                <div class="modal fade" id="pdfFilterModal" tabindex="-1" aria-labelledby="pdfFilterModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content modal-modern">
                            <div class="modal-header" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); color: white; border: none; padding: 1.5rem; border-radius: 8px 8px 0 0;">
                            ...
                            <form id="pdfFilterForm" action="{{ route('admin.alumnos.reporteGeneralPDF') }}" method="GET" target="_blank">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group-modern mb-3">
                                        <label for="tipo_documento" class="form-label">Filtrar por tipo de documento (Extranjero o Venezolano)</label>
                                        <select class="form-control-modern" id="tipo_documento" name="tipo_documento">
                                ...
                                <div class="modal-footer" style="border-top: 1px solid var(--gray-200); padding: 1.25rem 1.5rem;">
                                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" style="padding: 0.5rem 1.25rem; border-radius: 6px; font-weight: 500;">
