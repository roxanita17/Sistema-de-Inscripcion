...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Cédula: {{ $alumno->tipo_documento ?? 'N/A' }}-{{ $alumno->numero_documento ?? 'N/A' }}</p>
        ...
        <div class="section">
            ...
            <table class="info-grid">
                ...
                <tr class="info-item">
                    ...
                    <td class="info-value">
                        {{ $alumno->tipo_documento ?? 'N/A' }}-{{ $alumno->numero_documento ?? 'N/A' }}
                    </td>
                </tr>
                <tr class="info-item">
                ...
                <tr class="info-item">
                    ...
                    <td class="info-value">{{ $alumno->nombre_genero ?? 'N/A' }}</td>
                </tr>
            </table>
        </div>

        <!-- Sección Académica y de Salud -->
        <div class="section">
            <div class="section-title">INFORMACIÓN ACADÉMICA Y DE SALUD</div>
            <table class="info-grid">
                <tr class="info-item">
                    <td class="info-label">Institución:</td>
                    <td class="info-value">{{ $alumno->nombre_institucion ?? 'N/A' }}</td>
                </tr>
                <tr class="info-item">
                    <td class="info-label">Expresión literaria:</td>
                    <td class="info-value">{{ $alumno->letra_expresion_literaria ?? 'N/A' }}</td>
                </tr>
                <tr class="info-item">
                    <td class="info-label">Discapacidad:</td>
                    <td class="info-value">{{ $alumno->nombre_discapacidad ?? 'No' }}</td>
                </tr>
                <tr class="info-item">
                    <td class="info-label">Orden de nacimiento:</td>
                    <td class="info-value">{{ $alumno->orden_nacimiento ?? 'N/A' }}</td>
                </tr>
                <tr class="info-item">
                ...
                <tr class="info-item">
                    ...
                    <td class="info-value">{{ $alumno->lateralidad ?? 'N/A' }}</td>
                </tr>
                <tr class="info-item">
                    <td class="info-label">Etnia Indígena:</td>
                    <td class="info-value">{{ $alumno->etnia ?? 'N/A' }}</td>
                </tr>
                <tr class="info-item">
                    <td class="info-label">Año de egreso:</td>
                    <td class="info-value">{{ $alumno->anio_egreso ?? 'N/A' }}</td>
                </tr>
            </table>
        </div>
    </div>
