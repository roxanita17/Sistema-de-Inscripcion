            ...
            <div class="modal-body-create">
                <form id="formAnioEscolar" action="{{ route('admin.anio_escolar.modales.store') }}" method="POST"
                    ...
                    <div class="alert alert-info d-flex align-items-center mb-3"
                        ...
                        <span>Las fechas sugeridas son del <strong>10 de septiembre</strong> al <strong>10 de
                                junio</strong>. Puede modificarlas según cronograma.</span>
                    </div>
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="date" class="form-control-modern" id="inicio_anio_escolar"
                            name="inicio_anio_escolar" required>
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="date" class="form-control-modern" id="cierre_anio_escolar"
                            name="cierre_anio_escolar" required>
                    ...
                    <div id="info_duracion" class="alert alert-success d-none"
                        style="font-size: 0.85rem; padding: 0.5rem; margin-top: 1rem;">
                    ...
                    <div class="modal-footer-create">
                        <div class="footer-buttons">
                            ...
                            <button type="submit" class="btn-modal-create rd-submit-btn" id="btn_guardar_anio">
