    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-modern">
            <div class="modal-header-create">
                ...
                <h5 class="modal-title-create" id="modalCrearLabel">Nuevo Ocupacion</h5>
            ...
            <div class="modal-body-create">
                <form action="{{ route('admin.ocupacion.modales.store') }}" method="POST" id="formCrearOcupacion">
                    @csrf

                    <div id="contenedorAlertaCrear"></div>

                    <div class="form-group-modern">
                        <label for="nombre_ocupacion" class="form-label-modern">
                        ...
                        <input type="text" 
                               ...
                               inputmode="text"
                               maxlength="100"
                               placeholder="Ingrese el nombre de la ocupacion"
                               required>
