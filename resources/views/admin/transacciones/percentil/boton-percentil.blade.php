<form id="form-percentil" action="{{ route('admin.transacciones.percentil.boton-percentil') }}" method="POST"
    class="d-inline">
    @csrf
...
<script>
    function confirmarEnvio() {
        Swal.fire({
            title: '¿Desea ejecutar el percentil para este nivel academico?',
            text: '',
            icon: 'warning',
