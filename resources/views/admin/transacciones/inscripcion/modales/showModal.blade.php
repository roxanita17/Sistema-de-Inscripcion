        ...
        <div class="modal-content modal-modern shadow">
            ...
            <div class="modal-body modal-body-view">
                            ...
                            <div class="col-md-6">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">
                                        ...
                                        <small class="text-muted">({{ \Carbon\Carbon::parse($datos->alumno->persona->fecha_nacimiento)->age }} años)</small>
                                    </span>
                                </div>
                            </div>
                ...
                <div class="mb-4">
                    ...
                    @php
                        $todosDocumentos = [
                            'partida_nacimiento' => ['label' => 'Partida de Nacimiento', 'icon' => 'fa-file-alt', 'obligatorio' => true],
                            'copia_cedula_representante' => ['label' => 'Copia Cédula Representante', 'icon' => 'fa-id-card', 'obligatorio' => false],
                            'copia_cedula_estudiante' => ['label' => 'Copia Cédula Estudiante', 'icon' => 'fa-id-card', 'obligatorio' => false],
                            'boletin_6to_grado' => ['label' => 'Boletín 6to Grado', 'icon' => 'fa-file-invoice', 'obligatorio' => true],
                            'certificado_calificaciones' => ['label' => 'Certificado de Calificaciones', 'icon' => 'fa-certificate', 'obligatorio' => true],
                            'constancia_aprobacion_primaria' => ['label' => 'Constancia Aprobación Primaria', 'icon' => 'fa-stamp', 'obligatorio' => true],
                            'foto_estudiante' => ['label' => 'Fotografía Estudiante', 'icon' => 'fa-camera', 'obligatorio' => false],
                            'foto_representante' => ['label' => 'Fotografía Representante', 'icon' => 'fa-camera', 'obligatorio' => false],
                            'carnet_vacunacion' => ['label' => 'Carnet de Vacunación', 'icon' => 'fa-syringe', 'obligatorio' => false],
                            'autorizacion_tercero' => ['label' => 'Autorización Tercero', 'icon' => 'fa-file-signature', 'obligatorio' => false],
                        ];
                        $documentosEntregados = is_array($datos->documentos) ? $datos->documentos : (json_decode($datos->documentos, true) ?: []);
                    @endphp
                    ...
                    <div class="row g-2 mt-2">
                        ...
                        @endphp
                        <div class="col-md-6">
                            <div class="documento-item {{ $entregado ? 'documento-entregado' : 'documento-faltante' }}">
