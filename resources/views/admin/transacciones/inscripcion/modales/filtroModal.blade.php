        ...
        <div class="modal-content modal-modern">
            ...
            <div class="modal-body pt-0">
                <form method="GET" action="{{ route('admin.transacciones.inscripcion.index') }}" id="formFiltros">
                    ...
                    <select name="grado_id" id="grado_select" class="form-select form-control-modern">
                    ...
                    <select name="seccion_id" id="seccion_select" class="form-select form-control-modern"
