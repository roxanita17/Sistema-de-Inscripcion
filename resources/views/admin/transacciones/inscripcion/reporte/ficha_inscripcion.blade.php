        ...
        <div class="section">
            ...
            <div class="parent-section">
                ...
                <table class="parent-info">
                    ...
                    <tr>
                        <td><strong>Cédula de Identidad:</strong></td>
                        <td>{{ $datosCompletos['persona_madre']['tipo_documento_id'] == 1 ? 'V-' : 'E-' }}{{ $datosCompletos['persona_madre']['numero_documento'] ?? 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Fecha de Nacimiento:</strong></td>
                        <td>{{ isset($datosCompletos['persona_madre']['fecha_nacimiento']) ? \Carbon\Carbon::parse($datosCompletos['persona_madre']['fecha_nacimiento'])->format('d/m/Y') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="parent-section" style="margin-top: 20px;">
                ...
                <table class="parent-info">
                    ...
                    <tr>
                        <td><strong>Cédula de Identidad:</strong></td>
                        <td>{{ $datosCompletos['persona_padre']['tipo_documento_id'] == 1 ? 'V-' : 'E-' }}{{ $datosCompletos['persona_padre']['numero_documento'] ?? 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Fecha de Nacimiento:</strong></td>
                        <td>{{ isset($datosCompletos['persona_padre']['fecha_nacimiento']) ? \Carbon\Carbon::parse($datosCompletos['persona_padre']['fecha_nacimiento'])->format('d/m/Y') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Ocupación:</strong></td>
