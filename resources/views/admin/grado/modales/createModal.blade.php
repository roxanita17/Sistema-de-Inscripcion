    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-modern">
            <div class="modal-header-create">
                ...
                <h5 class="modal-title-create" id="modalCrearGradoLabel">Nuevo Nivel Academico</h5>
                ...
                <form action="{{ route('admin.grado.modales.store') }}" method="POST" id="formCrearGrado">
                    ...
                    <div class="form-group-modern">
                        <label for="numero_grado" class="form-label-modern">
                            <i class="fas fa-hashtag me-2"></i> Nivel Academico
                        </label>
                        <input type="text" class="form-control-modern" id="numero_grado" name="numero_grado"
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="capacidad_max" name="capacidad_max"
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="min_seccion" name="min_seccion"
                            inputmode="numeric" pattern="[0-9]+" maxlength="2"
                            oninput="this.value=this.value.replace(/[^0-9]/g,'')" required>
                        @error('min_seccion')
                            <div class="error-message">
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="max_seccion" name="max_seccion"
                            inputmode="numeric" pattern="[0-9]+" maxlength="2"
                            oninput="this.value=this.value.replace(/[^0-9]/g,'')" required>
                        @error('max_seccion')
                            <div class="error-message">
