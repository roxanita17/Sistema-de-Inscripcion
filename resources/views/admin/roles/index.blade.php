    ...
    <div class="content-header-modern">
        <div class="header-content">
            <div class="header-title">
                ...
                <div>
                    <h1 class="title-main">Gestión de Roles y Permisos</h1>
                    <p class="title-subtitle">Administración de los roles y permisos</p>
                </div>
            </div>

            {{-- Botón que abre la ventana modal para crear un nuevo rol --}}
            <button type="button" 
                    class="btn-create"
                    data-bs-toggle="modal"
                    data-bs-target="#modalCrear"
                    @if(!$anioEscolarActivo) disabled @endif
                    title="{{ !$anioEscolarActivo ? 'Debe registrar un año escolar activo' : 'Nuevo Rol' }}">
...
<div class="main-container">
    ...
    {{-- Contenedor principal de la tabla de roles --}}
        ...
        <div class="card-header-modern">
            <div class="header-left">
                ...
                <div>
                    ...
                    <p>{{ $roles->total() }} registros encontrados</p>
                </div>
            </div>
            ...
            <div class="table-wrapper">
                <table class="table-modern overflow-hidden hidden">
                    ...
                    <tbody style="text-align: center">
                        {{-- Si no hay roles, se muestra mensaje vacío --}}
                        @if ($roles->isEmpty())
                            <tr>
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <p>Agrega un nuevo rol con el botón superior</p>
                                    </div>
                                </td>
                            </tr>
                        @else
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <button class="action-btn btn-edit"
                                                ...
                                                title="Editar"
                                                @if(!$anioEscolarActivo) disabled @endif
                                                title="{{ !$anioEscolarActivo ? 'Debe registrar un año escolar activo' : 'Editar Rol' }}">
                                            ...
                                            <button class="action-btn btn-delete"
                                                ...
                                                title="Eliminar"
                                                @if(!$anioEscolarActivo) disabled @endif
                                                title="{{ !$anioEscolarActivo ? 'Debe registrar un año escolar activo' : 'Eliminar Rol' }}">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content modal-modern">
                                                ...
                                                <div class="modal-body-delete">
                                                    <p>¿Deseas eliminar esta rol?</p>
                                                    <p class="delete-warning">
                                                        Esta acción no se puede deshacer.
                                                    </p>
                                                </div>
                                                <div class="modal-footer-delete">
                                                    <form action="{{ url('admin/roles/' . $datos->id) }}" method="POST" class="w-100">
                                                        @csrf
                                                        @method('DELETE')
