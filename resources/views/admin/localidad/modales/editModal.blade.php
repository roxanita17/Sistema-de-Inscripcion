            ...
            <div class="modal-body-edit">
                <form wire:submit.prevent="update" id="formEditarLocalidad">
                    ...
                    <div class="form-group-modern">
                        ...
                        <select name="estado_id" wire:model.live="estado_id" id="estado_id_editar"
                    ...
                    <div class="form-group-modern">
                        ...
                        <select name="municipio_id" wire:model.live="municipio_id" id="municipio_id_editar"
                            class="form-control-modern" {{ empty($municipios) ? 'disabled' : '' }} required>
                            <option value="">Seleccione un municipio</option>
                            @foreach ($municipios as $municipio)
                                <option value="{{ $municipio->id }}"
                                    {{ $municipio_id == $municipio->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="nombre_localidad_editar"
                            wire:model.defer="nombre_localidad" inputmode="text" maxlength="100"
                            placeholder="Edite el nombre de la localidad" required>
