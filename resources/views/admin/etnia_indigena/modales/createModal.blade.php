            ...
            <div class="modal-body-create">
                <form action="{{ route('admin.etnia_indigena.modales.store') }}" method="POST" id="formCrear">
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="nombre" name="nombre" inputmode="text"
                            pattern="[a-zA-Z ]+" maxlength="50" placeholder="Ingrese el nombre de la etnia indígena"
                            required>
                        @error('nombre')
