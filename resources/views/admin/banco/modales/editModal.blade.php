            ...
            <div class="modal-body-edit">
                <form action="{{ route('admin.banco.modales.update', $datos->id) }}" method="POST">
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="codigo_banco_{{ $datos->id }}"
                            name="codigo_banco" type="text" inputmode="numeric" pattern="[0-9]+" maxlength="4"
                            placeholder="Edite el codigo" value="{{ $datos->codigo_banco }}" required>
                        @error('codigo_banco')
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type="text" class="form-control-modern" id="nombre_banco_{{ $datos->id }}"
                            name="nombre_banco" type="text" inputmode="text" maxlength="100"
                            placeholder="Edite el nombre" value="{{ $datos->nombre_banco }}" required>
                        @error('nombre_banco')
                            <div class="error-message">
                                Este campo es obligatorio.
                            </div>
