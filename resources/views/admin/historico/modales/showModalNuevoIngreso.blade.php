...
@endphp
<div class="modal fade" id="viewModalNuevoIngreso{{ $datos->id }}" tabindex="-1" aria-labelledby="viewModalNuevoIngresoLabel{{ $datos->id }}"
    aria-hidden="true">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">
                                        ...
                                        |
                                        <span
                                            @if ($datos->anioEscolar->status === 'Activo') class="badge badge-active"
                                    @else
                                        class="badge badge-inactive" @endif>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">
                                        {{ $datos->nuevoIngreso->anio_egreso ?? 'N/A' }}
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">
                                        {{ $datos->nuevoIngreso->numero_zonificacion ?? 'N/A' }}
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-4">
