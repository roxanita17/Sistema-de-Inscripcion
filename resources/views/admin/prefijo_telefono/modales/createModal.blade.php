                ...
                <form action="{{ route('admin.prefijo_telefono.modales.store') }}" method="POST" id="formCrearPrefijo">
                    ...
                    <div class="form-group-modern">
                        <label for="prefijo" class="form-label-modern">
                            <i class="fas fa-hashtag me-2"></i> Número de Prefijo
                        </label>
                        <input input type="text" class="form-control" id="prefijo" name="prefijo"
                            inputmode="numeric" pattern="[0-9]+" maxlength="4"
                            oninput="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="Ejemplo: 0412" required>
                        @error('prefijo')
