...
@include('admin.prefijo_telefono.modales.createModal')
    ...
    {{-- Botón para abrir la modal de crear prefijo --}}
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCrearPrefijo">
        <i class="fas fa-plus"></i> Crear Prefijo
    </button>
    ...
    <div class="table-responsive">
        <table class="table table-striped align-middle text-center" id="tablaAnioEscolar">
            ...
            <tbody id="tbodyAnioEscolar">
                @if ($prefijos->isEmpty())
                                <tr>
                                    <td colspan="4" style="text-align: center;">No se encontraron prefijos.</td>
                                </tr>
                            @endif
                @foreach ($prefijos as $datos)
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Estás seguro de que deseas eliminar este prefijo?
                                        </div>
                                        <div class="modal-footer">
                                            <form action="{{ url('admin/prefijo_telefono/' . $datos->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
